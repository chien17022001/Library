...
<body class="disable_transitions sidebar_main_open sidebar_main_swipe">
    ...
    <div id="page_content">
        <div id="page_content_inner">
            ...
            <div class="uk-grid uk-grid-width-large-1-4 uk-grid-width-medium-1-2 uk-grid-medium uk-sortable sortable-handler hierarchical_show" data-uk-sortable data-uk-grid-margin>
                ...
                <div>
                    <div class="md-card">
                        <div class="md-card-content">
                            <div class="uk-float-right uk-margin-top uk-margin-small-right"></div>
                            <span class="uk-text-muted uk-text-small">Sách bị mất/hỏng</span>
            ...
            <div class="uk-grid uk-grid-width-large-1-4 uk-grid-width-medium-1-2 uk-grid-medium uk-sortable sortable-handler hierarchical_show" data-uk-sortable data-uk-grid-margin>
                ...
                <div>
                    <div class="md-card">
                        <div class="md-card-content">
                            <div class="uk-float-right uk-margin-top uk-margin-small-right"></div>
                            <span class="uk-text-muted uk-text-small">Tiền phạt sách bị mất</span>
                            <h2 class="uk-margin-remove">VNĐ <?php echo $lostBookfines;?></h2>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    <div class="md-card">
                        <div class="md-card-content">
                            <div class="uk-float-right uk-margin-top uk-margin-small-right"></div>
                            <span class="uk-text-muted uk-text-small">Tiền phạt sách bị hỏng</span>
                            <h2 class="uk-margin-remove">VNĐ <?php echo $damangedBookfines;?></h2>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    <div class="md-card">
                        <div class="md-card-content">
                            ...
                            <h2 class="uk-margin-remove">VNĐ <?php echo $totalFine;?></h2>
                        </div>
                    </div>
                </div>
                <div>
                    <div class="md-card">
                        <div class="md-card-content">
                            <div class="uk-float-right uk-margin-top uk-margin-small-right"></div>
                            <span class="uk-text-muted uk-text-small">Tổng tiền phạt</span>
                            <h2 class="uk-margin-remove">VNĐ <?php echo $paidFine;?></h2>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="uk-grid">
                <div class="uk-width-1-1">
                    <h4 class="heading_a uk-margin-bottom">Sách</h4>
                    <div class="md-card">
                        <div class="md-card-content">
