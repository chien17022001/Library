...
<body class="disable_transitions sidebar_main_open sidebar_main_swipe">
    ...
    <div id="page_content">
        <div id="page_content_inner">
            ...
            <div class="uk-grid uk-grid-width-large-1-4 uk-grid-width-medium-1-2 uk-grid-medium uk-sortable sortable-handler hierarchical_show" data-uk-sortable data-uk-grid-margin>
                <div>
                    <div class="md-card">
                        <div class="md-card-content">
                            ...
                            <span class="uk-text-muted uk-text-small">Thể loại sách</span>
                ...
                <div>
                    <div class="md-card">
                        <div class="md-card-content">
                            <div class="uk-float-right uk-margin-top uk-margin-small-right"></div>
                            <span class="uk-text-muted uk-text-small">Sách</span>
                ...
                <div>
                    <div class="md-card">
                        <div class="md-card-content">
                            <div class="uk-float-right uk-margin-top uk-margin-small-right"></div>
                            <span class="uk-text-muted uk-text-small">Sách đã trả</span>
                ...
                <div>
                    <div class="md-card">
                        <div class="md-card-content">
                            <div class="uk-float-right uk-margin-top uk-margin-small-right"></div>
                            <span class="uk-text-muted uk-text-small">Mất/Hỏng sách</span>
            ...
            <div class="uk-grid uk-grid-width-large-1-4 uk-grid-width-medium-1-2 uk-grid-medium uk-sortable sortable-handler hierarchical_show" data-uk-sortable data-uk-grid-margin>
                <div>
                    <div class="md-card">
                        <div class="md-card-content">
                            <div class="uk-float-right uk-margin-top uk-margin-small-right"></div>
                            <span class="uk-text-muted uk-text-small">Thủ thư</span>
                ...
                <div>
                    <div class="md-card">
                        <div class="md-card-content">
                            <div class="uk-float-right uk-margin-top uk-margin-small-right"></div>
                            <span class="uk-text-muted uk-text-small">Sinh viên đã đăng kí</span>
            ...
            <div class="uk-grid uk-grid-width-large-1-4 uk-grid-width-medium-1-2 uk-grid-medium uk-sortable sortable-handler hierarchical_show" data-uk-sortable data-uk-grid-margin>
                ...
                <div>
                    <div class="md-card">
                        <div class="md-card-content">
                            <div class="uk-float-right uk-margin-top uk-margin-small-right"></div>
                            <span class="uk-text-muted uk-text-small">Tổng tiền phạt</span>
                            <h2 class="uk-margin-remove"><?php echo $totalFine;?> VNĐ</h2>
                        </div>
                    </div>
                </div>
            </div>    
            <div class="uk-grid uk-grid-width-large-1-4 uk-grid-width-medium-2-1 uk-grid-medium uk-sortable sortable-handler hierarchical_show" data-uk-sortable data-uk-grid-margin>
                <div>
                    <div class="md-card">
                        <div class="md-card-content">
                            <div class="uk-float-right uk-margin-top uk-margin-small-right"></div>
                            <span class="uk-text-muted uk-text-small">Tiền phạt bị mất sách</span>
                            <h2 class="uk-margin-remove"><?php echo $lostBookfines;?> VNĐ</h2>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    <div class="md-card">
                        <div class="md-card-content">
                            <div class="uk-float-right uk-margin-top uk-margin-small-right"></div>
                            <span class="uk-text-muted uk-text-small">Tiền phạt bị hỏng sách</span>
                            <h2 class="uk-margin-remove"><?php echo $damangedBookfines;?> VNĐ</h2>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    <div class="md-card">
                        <div class="md-card-content">
                            <div class="uk-float-right uk-margin-top uk-margin-small-right"></div>
                            <span class="uk-text-muted uk-text-small">Tổng tiền</span>
                            <h2 class="uk-margin-remove"><?php echo $paidFine;?> VNĐ</h2>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    <div class="md-card">
                        <div class="md-card-content">
                            ...
                            <h2 class="uk-margin-remove"><?php echo $pendingFine;?> VNĐ</h2>
                        </div>
                    </div>
                </div>
            ...
            <div class="uk-grid">
                <div class="uk-width-1-1">
                    <h4 class="heading_a uk-margin-bottom">Nhân viên thư viện</h4>
                    <div class="md-card">
                        <div class="md-card-content">
            ...
            <div class="uk-grid">
                <div class="uk-width-1-1">
                    <h4 class="heading_a uk-margin-bottom">Sinh viên</h4>
                    <div class="md-card">
                        <div class="md-card-content">
